...
{
	WrProtdRegPortJ_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegPort0_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegPort1_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegPort2_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegPort3_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegPort4_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegPort5_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegSys_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegSys_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegSysClmac_u32(WrVal, WrAddr);
}
...
{
	WrProtdRegClma0_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegClma1_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegClma2_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegClma3_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegEcmm_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegEcmc_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegEcm_u08(WrVal, WrAddr);
}
...
{
	WrProtdRegEcm_u16(WrVal, WrAddr);
}
...
{
	WrProtdRegEcm_u32(WrVal, WrAddr);
}
