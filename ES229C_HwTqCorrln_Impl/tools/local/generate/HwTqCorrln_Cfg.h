...
* Generation Time   : 28.03.2017 09:22:03
***********************************************************************************************************************
* Version Control:
* %version:          1 %
* %derived_by:       nz2796 %
...
#define HWTQCORRLN_HWTQACORRLNFLTNTCNR_CNT_ENUM                   NTCNR_0X070
#define HWTQCORRLN_HWTQBCORRLNFLTNTCNR_CNT_ENUM 				  NTCNR_0X071
#define HWTQCORRLN_HWTQCCORRLNFLTNTCNR_CNT_ENUM	     			  NTCNR_0X072
#define HWTQCORRLN_HWTQDCORRLNFLTNTCNR_CNT_ENUM                   NTCNR_0X073
